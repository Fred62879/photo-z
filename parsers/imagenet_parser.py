...
def define_cmd_line_args():
    ...
    data_group.add_argument('--data_path', default='/path/to/imagenet/train/', type=str,
                        help='Please specify path to the ImageNet training data.')
    data_group.add_argument('--output_dir', default=".", type=str,
    ...
    data_group.add_argument('--dataset-num-workers', default=10, type=int,
