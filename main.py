...
if __name__ == "__main__":
    ...
    from utils.get_from_config import get_pipeline, get_redshift_dataset, get_redshift_trainer, split_source_table, get_optimizer #, get_imagenet_dataset, get_imagenet_trainer
